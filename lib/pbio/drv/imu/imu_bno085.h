...
typedef struct {
    ...
    uint8_t system;   // System: 0-3
} bno085_calibration_t;
...
bno085_calibration_t pbdrv_imu_bno085_get_calibration(void);

// Get calibration as raw byte (bits 0-1=mag, 2-3=accel, 4-5=gyro, 6-7=system)
uint8_t pbdrv_imu_bno085_get_calibration_raw(void);
